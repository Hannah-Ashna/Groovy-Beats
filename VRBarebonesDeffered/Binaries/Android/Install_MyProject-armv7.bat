...
%ADB% %DEVICE% install MyProject-armv7.apk
...
%ADB% %DEVICE% push main.1.com.YourCompany.MyProject.obb %STORAGE%/obb/com.YourCompany.MyProject/main.1.com.YourCompany.MyProject.obb
if "%ERRORLEVEL%" NEQ "0" goto Error
